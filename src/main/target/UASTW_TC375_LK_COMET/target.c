...
timerHardware_t timerHardware[] = {
    ...
    DEF_TIM(atomDriver[1], IfxGtm_ATOM0_2N_TOUT15_P00_6_OUT,    MOTOR_2_PIN, IOCFG_OUT_PP, TIM_USE_MOTOR),
    DEF_TIM(atomDriver[2], IfxGtm_ATOM0_7N_TOUT12_P00_3_OUT,    MOTOR_3_PIN, IOCFG_OUT_PP, TIM_USE_MOTOR),
